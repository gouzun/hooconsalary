...
const D30Input = ({ titleObject }) => {

    const { titlename } = titleObject;

    const { d30, setD30 } = useContext(ProjectListContext);
    ...
    return (<div className="flex-wrap justify-center px-10 py-2 w-80 items-end gap-4">
        <Input id={titlename} label={titlename} value={d30} onChange={handleChange} />
    </div>
    );

}

export default D30Input;