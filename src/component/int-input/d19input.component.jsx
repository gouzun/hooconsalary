...
const D19Input = ({ titleObject }) => {

    const { titlename } = titleObject;

    const { d19, setD19 } = useContext(ProjectListContext);
    ...
    return (<div className="flex-wrap justify-center px-10 py-2 w-80 items-end gap-4">
        <Input id={titlename} label={titlename} value={d19} onChange={handleChange} />
    </div>
    );

}

export default D19Input;