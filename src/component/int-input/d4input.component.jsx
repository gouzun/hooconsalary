...
const D4Input = ({ titleObject }) => {

    const { titlename } = titleObject;

    const { d4, setD4 } = useContext(ProjectListContext);
    ...
    return (<div className="flex-wrap justify-center px-10 py-2 w-80 items-end gap-4">
        <Input id={titlename} label={titlename} value={d4} onChange={handleChange} />
    </div>
    );

}

export default D4Input;