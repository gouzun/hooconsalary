...
import { generateWorkerList, addNewFBWorker } from '../../utils/firebase/firebase.utils';
import { Button } from "@material-tailwind/react";

const ViewWorker = () => {

    const { addWName,searchProject,addWWorkscope } = useContext(ProjectListContext);
    ...
    const gridHandler = async () => {
        ...
        let arrResult = await generateWorkerList();
    ...
    const addHandler = async () => {
        ...
        await addNewFBWorker(addWName,searchProject,addWWorkscope)
            .then(
